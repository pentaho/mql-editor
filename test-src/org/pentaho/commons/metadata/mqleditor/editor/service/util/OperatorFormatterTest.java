...
public class OperatorFormatterTest {
  ...
  public void formatIn_single() {
    ...
    assertEquals("IN([CAT.COL];\"value\")", formatted); //$NON-NLS-1$
  }
  ...
  public void formatIn_single_with_space() {
    ...
    assertEquals("IN([CAT.COL];\"value 1\")", formatted); //$NON-NLS-1$
  }
  ...
  public void formatIn_two() {
    ...
    assertEquals("IN([CAT.COL];\"value\";\"2\")", formatted); //$NON-NLS-1$
  }
  ...
  public void formatIn_two_quotes_with_whitespace_2() {
    ...
    assertEquals("IN([CAT.COL];\"2\";\"value\")", formatted); //$NON-NLS-1$
  }
  ...
  public void formatIn_two_whitepace() {
    ...
    assertEquals("IN([CAT.COL];\"2\";\"value 2\")", formatted); //$NON-NLS-1$
  }
  ...
  public void formatIn_multiple() {
    ...
    assertEquals("IN([CAT.COL];\"2\";\"value 2\";\"whitespace&\";\"test\";\"||\")", formatted); //$NON-NLS-1$
  }
