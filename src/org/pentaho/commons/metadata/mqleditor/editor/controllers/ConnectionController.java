...
public class ConnectionController extends AbstractXulEventHandler {
  ...
  public void deleteConnection() {
    ...
    service.deleteConnection(datasourceModel.getSelectedConnection().getName(), 
  ...
  public void saveConnection() {
    if(EditType.ADD.equals(datasourceModel.getEditType())) {
      service.addConnection(connectionModel.getConnection(), 
          new XulServiceCallback<Boolean>(){
      ...
      service.updateConnection(connectionModel.getConnection(), 
          new XulServiceCallback<Boolean>(){
